 ...
 */
public class MenuUpgrade extends JFrame implements ActionListener{
    ...
    /**
     * Constructor for objects of class MenuUpgrade
     */
    ...
    void Dialog(){
        ...
        Box.setBounds(x,y,150,70);
        System.out.println("please type in a text");
        TextArea area = new TextArea(string1);
        Box.add(area);
        Box.toFront();
        Box.setVisible(true);
        Box.setTitle("How can I help");
    }
